package com.jinlink.modules.monitor.scheduler.listener;
...
public class SchedulerJobListener implements JobListener {
    ...
    private final MonLogsSchedulerService monLogsSchedulerService;

    public SchedulerJobListener(MonLogsSchedulerService monLogsSchedulerService) {
        this.monLogsSchedulerService = monLogsSchedulerService;
        log.info("SchedulerJobListener constructed with monLogsSchedulerFacade: {}", monLogsSchedulerService);
    }
    ...
    public void jobWasExecuted(JobExecutionContext context, JobExecutionException e) {
        ...
        // 构建调度日志新增对象
        MonLogsScheduler build = MonLogsScheduler.builder()
        ...
        // 添加调度日志
        monLogsSchedulerService.save(build);
    }
}
